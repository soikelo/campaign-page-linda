const translations = {
    ...
    en: {
        ...
        Nokia.</p>
        <p>I currently work as a customer adviser in the energy sector and I
        have studied International Relations and Political Science at the
        University of Tampere. Previously, I have worked at Tampere Hall
        and Stockmann, among others, for long periods of time.</p>
        <p>Among the things that excite me the most are culture and music,
        houseplants, quizzes and learning. I satisfy my natural curiosity with
        my young child: we go to the library and the local swimming pool,
        do arts and crafts and play with Legos.</p>`,
        justification: `<h2>Why am I standing for election?</h2>
        <p>I am standing for election in the municipal elections because I
        primarily want to secure the public services in my home town such
        as maternity clinics, daycare, healthcare, the quality of education
        and accessible local nature.</p>
        <p>It is utterly incomprehensible that jointly paid taxes can't guarantee
        us good healthcare and treatment when we need it, that children
        have to study in moldy school buildings in way too large groups,
        that families have to stand in line to be provided food aid and that
        the number of homeless people is yet increasing. It is possible to
        tackle and prevent all said problems if there is political will.</p>
        <p>What aggravates me the most is injustice and unfairness, especially
        in working life. I was paid too little for years (luckily, it was
        compensated retroactively), I have worked on a zero-hour
        employment contract for several years, and my income has been
        very uncertain especially during my years of studying.</p>
        <p>Everyone should be able to live off their salary or pension in
        Finland. There are, however, situations in life where anyone of us could need housing allowance or social assistance, for instance. It
        is totally wrong that people are being punished for being
        unemployed and that the people who have the least to start with are
        the ones whose benefits are being cut.</p>
        <p>I'm an active and productive person by nature, but I may be a little
        ...
        feeling and wish we all could look forward to each day's adventures
        with an open and comfortable mind rather than be wary of the
        possible horrors to come.</p>
        <p>In the news, we learn how war, greed for power and fascism are
        taking the world by storm, which makes me want to crawl under a
        blanket and hide away. However, hope is the one asset that gives
        me courage to dream of and imagine a better future. I owe it to my
        posterity and future generations to do what I can in order to make a
        difference.</p>
        <p>I don't want children and the young to lose their spark. I want them
        to feel like they matter and are heard and that the world belongs to
        them. That we are capable of taking care of societal matters
        together. That we all have a future where everything isn't weighed
        in money. Dreams and idealistic ideas are not just vagaries but an
        ...
        planning, winter maintenance on bike lanes and walkways,
        gynaecological services at health clinics and free contraception for
        everyone under the age of 25.</p>
        <p>I long for courage and fresh new ideas in the cityscape, such as a
        whole new community garden with moderate prices, accessible
        allotments or a new public bath. There should be trees for shade at
        all playgrounds. Biodiversity can be maintained by bus stops with
        turf roofs and bee meadows on wastelands, and flood water can be
        restrained with appropriately built storm water wetlands.</p>
        <p>I want artists and people in the cultural line of business to have
        inexpensive workspaces to be creative in and children and the
        young to have access to hobbies regardless of the income of their
        families. It's about time we arrange a contest to design a monument
        for the late pioneer artist Kikka in the city of Manserock!</p>
        <p>Tampere has developed immensely since I was a child and was
        waiting for a bus that ran twice an hour to take me from Tesoma to
        Pispala where I studied in a music-oriented class. Now we have a constantly expanding tram network and a commuter train. Public
        transport is not only ecological and frees up city space for other
        usage, but also reduces particulate pollution and, consequently,
        improves air quality.</p>
        <p>I want Tampere to be an attractive city that provides a life of quality
        for everyone and not just for the wealthy part of the population.
        What makes Tampere so original is that you can go from the opera
        to a punk rock gig or from a basketball game to pick blueberries in
        the forest. Each one of us should have the chance to lead a life to
